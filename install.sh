...
echo ""
echo "O servidor será iniciado, por padrão, na porta 3000."
echo "Se você estiver em uma VPS, lembre-se de configurar seu firewall para permitir tráfego na porta escolhida."
echo ""
echo "Para manter a aplicação rodando em segundo plano, recomendamos usar um gerenciador de processos como o 'pm2':"
